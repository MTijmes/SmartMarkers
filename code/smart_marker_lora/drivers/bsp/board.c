...
void BoardInitMcu(void)
{
    if (McuInitialized == false) {
        ...
        UsbIsConnected = true;
        FifoInit(&Uart2.FifoTx, UartTxBuffer, UART_FIFO_TX_SIZE);
        FifoInit(&Uart2.FifoRx, UartRxBuffer, UART_FIFO_RX_SIZE);
...
{
    /* TODO: Add battery measure voltage function */
    return 0;
}
...
{
    /* TODO: Add get battery level function */
    return 0;
}
