...
/* TODO: Fix up the style in this function */
        ...
        case 224:
            if (ComplianceTest.Running == false) {
                ...
                case 0: // Check compliance test disable command (ii)
                    ...
                    MibRequestConfirm_t mibReq;
                    mibReq.Type = MIB_ADR;
//                    mibReq.Param.AdrEnable = AppSettings.AdrOn;               // TODO: Set new app settings
                    LoRaMacMibSetRequestConfirm(&mibReq);
#if defined(REGION_EU868)
//                    LoRaMacTestSetDutyCycleOn(AppSettings.DutyCycleOn);     // TODO: Set new app settings
#endif
                    break;
                case 1: // (iii, iv)
                    AppDataSize = 2;
...
//                        mlmeReq.Req.Join.DevEui = AppSettings.DevEui;             // TODO: Set new app settings
//                        mlmeReq.Req.Join.AppEui = AppSettings.AppEui;             // TODO: Set new app settings
//                        mlmeReq.Req.Join.AppKey = AppSettings.AppKey;             // TODO: Set new app settings
