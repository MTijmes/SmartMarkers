...
\newcommand{\doctitlepage}{
  ...
  \ThisCenterWallPaper{0.75}{projectplan/windesheim_kadaster.png}
  \vfill
...
\addbibresource{projectplan/bibliography.bib}
...
\RedeclareSectionCommand[beforeskip=.25\baselineskip,
                         afterskip=0\baselineskip]{subsubsection}

\RedeclareSectionCommand[beforeskip=.125\baselineskip,
                         afterskip=0\baselineskip]{paragraph}

\let\subsectionnl\subsection
\renewcommand{\subsection}[1]{\subsectionnl{#1} \hfill \break}

\let\subsubsectionnl\subsubsection
\renewcommand{\subsubsection}[1]{\subsubsectionnl{#1} \hfill \break}

\let\paragraphnl\paragraph
\renewcommand{\paragraph}[1]{\paragraphnl{#1} \hfill \break}
...
\newpage
\input{projectplan/versionmanagement}

\newpage
\input{projectplan/introduction}

\newpage
\input{projectplan/assignment}

\newpage
\input{projectplan/quality}

\newpage
\input{projectplan/organisation}

\newpage
\input{projectplan/planning}
