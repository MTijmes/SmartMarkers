...
\newpage
\input{final_report/1_versionmanagement}

\newpage
\input{final_report/2_introduction}

\newpage
\input{final_report/3_product}

\newpage
\input{final_report/4_process}

\newpage
\input{final_report/5_ethics}

\newpage
\input{final_report/6_security}

\newpage
\input{final_report/7_reflection}
